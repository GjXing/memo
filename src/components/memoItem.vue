...
<div class="memo-container">
  <div class="memo" :data-completed="memo.isCompleted ? 'true' : 'false'" style="height: 345.5px;">
    ...
    <div class="content" :data-type="memo.type === 0 ? 'text' : 'doodle'" style="width: 225px; height: 225px;">
  ...
  methods: {
    ...
    editMarkdown () {
      switch (this.memo.type) {
        case 0:
          bus.$emit('editMarkdown', this.memo);
          break;
        case 1:
          bus.$emit('editDoodle', this.memo);
          break;
      }
    },
  },
